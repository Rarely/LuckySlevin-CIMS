...
<div class="modal fade" <?php echo "id=\"largeIdea" . $idea['Idea']['id'] . "\"" ?> tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" <?php echo "data-id=" . $idea['Idea']['id'] ?> >
